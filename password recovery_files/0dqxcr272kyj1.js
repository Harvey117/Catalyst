;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="0fa26abd-6bd1-c01d-6f52-ada414ae6bf7")}catch(e){}}();
...
}`,q=`DATABASE_URL=${h}`,x=a?`psql "postgresql://${c}:${n}@${_}:${m}/${d}?options=reference%3D${r}"`:`psql -h ${_} -p ${m} -d ${d} -U ${c}`,E=t?.connectionString??"",S=`DATABASE_URL=${t?.connectionString}`,v=`user=${c} 
password=${n} 
host=${_}
port=${m}
...
host=${l} 
port=${i} 
dbname=${u}`},pooler:{psql:x,uri:E,golang:v,jdbc:j,dotnet:y,nodejs:S,php:v,python:v,sqlalchemy:`user=${c} 
password=${n} 
host=${_} 
port=${m} 
dbname=${d}`}}}])}]);

//# debugId=0fa26abd-6bd1-c01d-6f52-ada414ae6bf7
//# sourceMappingURL=0~-4n~r1yyfjl.js.map